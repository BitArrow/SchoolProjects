...
namespace RepoPraxApp.Web.Controllers
{
    public class ContactTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContactTypeId,TypeName")] ContactType contactType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactTypeId,TypeName")] ContactType contactType)
        {
            if (ModelState.IsValid)
            {
